...
class World {
    ...
    checkThrowObjects() {
        ...
        if (this.keyboard.D && this.collectedBottles > 0 && (currentTime - this.lastThrowTime >= 1500) && !this.character.otherDirection){
   ...
   */
    handleCharacterEnemyCollision(enemy) {
        if (enemy instanceof Endboss) {
            ...
            const isCharacterLandingOnEnemy = this.character.y + this.character.height >= enemy.y &&
